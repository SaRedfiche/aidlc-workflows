...
export async function run(
  ...
  const recoveryReason = "AI-DLC could not match this Copilot command to current coordination evidence. Run a fresh `aidlc engine orchestrate next`; do not reuse an earlier continuation token.";
