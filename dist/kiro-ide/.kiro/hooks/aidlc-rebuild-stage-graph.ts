...
import {
  ...
  runtimeGraphPath,
<<<<<<< HEAD:dist/kiro-ide/.kiro/hooks/aidlc-rebuild-stage-graph.ts
  harnessDir,
  writeSessionIntentHandoff,
  writeSessionIntentUuid,
||||||| parent of a7ee3db2a (fix: close native install integration gaps):dist/claude/.claude/hooks/aidlc-runtime-compile.ts
  harnessDir,
=======
>>>>>>> a7ee3db2a (fix: close native install integration gaps):dist/claude/.claude/hooks/aidlc-runtime-compile.ts
