...
<<<<<<< HEAD:dist/kiro-ide/.kiro/hooks/aidlc-sync-workflow-state.ts
...
||||||| parent of a7ee3db2a (fix: close native install integration gaps):dist/claude/.claude/hooks/aidlc-sync-statusline.ts
// Update state file via set-status (call the utility tool directly)
const toolPath = join(projectDir, harnessDir(), "tools", "aidlc-utility.ts");
...
>>>>>>> a7ee3db2a (fix: close native install integration gaps):dist/claude/.claude/hooks/aidlc-sync-statusline.ts
return 0;
}
