...
import {
  ...
  runtimeGraphPath,
<<<<<<< HEAD:dist/claude/.claude/hooks/aidlc-rebuild-stage-graph.ts
  harnessDir,
  writeSessionIntentHandoff,
  writeSessionIntentUuid,
||||||| parent of a7ee3db2a (fix: close native install integration gaps):dist/kiro/.kiro/hooks/aidlc-runtime-compile.ts
  harnessDir,
=======
>>>>>>> a7ee3db2a (fix: close native install integration gaps):dist/kiro/.kiro/hooks/aidlc-runtime-compile.ts
